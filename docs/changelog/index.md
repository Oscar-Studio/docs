...
<div style={{display: "flex", gap: "0.5rem", margin: "1rem 0 2rem", flexWrap: "wrap"}}>
  <Link className="button button--primary button--lg" to="/changelog/2026-09-26-docs-url-routing-fix">查看最新</Link>
</div>

## [2026-09-26](/changelog/2026-09-26-docs-url-routing-fix)
...
## [2026-09-25](/changelog/2026-09-25-six-stroke-engine)

- ✨ [六冲程汽油机工作循环模拟器](/teaching-tools/六冲程汽油机工作循环模拟器) 上线：完整六冲程循环演示 + 实时缸压/温度仪表盘

## [2026-09-20](/changelog/2026-09-20-mental-memory-timer)

- ⚡ [心算记忆](/games/心算记忆) 加入倒计时机制，按难度 60 / 120 / 180 秒分级

## [2026-09-19](/changelog/2026-09-19-new-game-and-tool)

- ✨ [心算记忆](/games/心算记忆) 上线：10 级难度的工作记忆训练游戏
- ✨ [位似图形](/teaching-tools/位似图形) 上线：2D / 3D 位似变换交互演示

## [2026-09-13](/changelog/2026-09-13-twenty-four-revamp)

- ⚡ [二十四点](/games/二十四点) 重新制作，界面与交互逻辑全面优化

## [2026-09-12](/changelog/2026-09-12-changelog-launch)
