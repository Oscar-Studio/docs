...
- [查看当日完整记录 →](/changelog/2026-09-26-docs-url-routing-fix)

## 2026-09-25

- ✨ [六冲程汽油机工作循环模拟器](/teaching-tools/六冲程汽油机工作循环模拟器) 上线：完整六冲程循环演示 + 实时缸压/温度仪表盘
- [查看当日完整记录 →](/changelog/2026-09-25-six-stroke-engine)

## 2026-09-20

- ⚡ [心算记忆](/games/心算记忆) 加入倒计时机制，按难度 60 / 120 / 180 秒分级
- [查看当日完整记录 →](/changelog/2026-09-20-mental-memory-timer)

## 2026-09-19

- ✨ [心算记忆](/games/心算记忆) 上线：10 级难度的工作记忆训练游戏
- ✨ [位似图形](/teaching-tools/位似图形) 上线：2D / 3D 位似变换交互演示
- [查看当日完整记录 →](/changelog/2026-09-19-new-game-and-tool)

## 2026-09-13

- ⚡ [二十四点](/games/二十四点) 重新制作，界面与交互逻辑全面优化
- [查看当日完整记录 →](/changelog/2026-09-13-twenty-four-revamp)

## 2026-09-12

- ✨ 更新日志模块上线，docs 主页新增「最近更新」卡片
- [查看当日完整记录 →](/changelog/2026-09-12-changelog-launch)
